...
namespace Petsy.Services
{
    ...
    interface IClientRestApiRefit
    {
        ...
        [Post("/GetPetsByUserId")]
        Task<GetPetsByUserIdResponse> GetPetsByUserId(UserIdRequest userIdRequest);

        [Post("/GetOrdersByUserId")]
        Task<GetOrdersByUserIdResponse> GetOrdersByUserId(UserIdRequest userIdRequest);

        [Post("/GetUrdersBySitterId")]
        Task<GetOrdersBySitterIdResponse> GetOrdersBySitterId(SitterIdRequest sitterIdRequest);
    }
}
